...
class OrderHistoryFuntions {
    ...
    loadOrderHistory() {
        ...
        <td>
            <button class="btn btn-primary btn-sm" onclick="orderHistoryController.viewOrderDetail('${order.id}'updateDashboardinfos())">
                View
            </button>
        </td>
        </tr>
...
const orderHistoryController = new OrderHistoryFuntions();
